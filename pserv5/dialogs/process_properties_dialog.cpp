...
namespace pserv
{
    ...
    void ProcessPropertiesDialog::Render()
    {
        ...
        std::string windowTitle = m_processStates.size() == 1 ? std::format("Process Properties: {}", m_processStates[0].name)
        ...
        if (ImGui::BeginTabBar("DetailsTabs"))
        {
            ...
            if (ImGui::BeginTabItem("General"))
            {
                ...
                if (ImGui::BeginTable("GeneralTable", 2))
                {
                    ...
                    ImGui::Text("%s", state.user.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Parent PID:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%u", state.parentPid);

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Priority:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.priority.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Started:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.startTime.c_str());
            ...
            if (ImGui::BeginTabItem("Statistics"))
            {
                ...
                if (ImGui::BeginTable("StatsTable", 2))
                {
                    ...
                    ImGui::Text("CPU Time:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s (Kernel: %s, User: %s)", state.totalCpuTime.c_str(), state.kernelCpuTime.c_str(), state.userCpuTime.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Working Set:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s (Peak: %s)", state.workingSet.c_str(), state.peakWorkingSet.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Private Bytes:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.privateBytes.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Virtual Size:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.virtualSize.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Paged Pool:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.pagedPool.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Non-Paged Pool:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.nonPagedPool.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Page Faults:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.pageFaults.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Threads:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.threadCount.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Handles:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.handleCount.c_str());
