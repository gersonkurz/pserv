...
namespace pserv
{
    ...
    void WindowPropertiesDialog::Render()
    {
        ...
        std::string windowTitle = m_windowStates.size() == 1 ? std::format("Window Properties: {}", m_windowStates[0].id)
        ...
        if (ImGui::BeginTabBar("DetailsTabs"))
        {
            ...
            if (ImGui::BeginTabItem("General"))
            {
                ...
                if (ImGui::BeginTable("GeneralTable", 2))
                {
                    ...
                    ImGui::Text("%s", state.id.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Class:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.className.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Control ID:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.windowId.c_str());
                ...
                if (ImGui::BeginTable("ProcessTable", 2))
                {
                    ...
                    ImGui::Text("Process:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s (PID: %s)", state.processName.c_str(), state.processId.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Thread ID:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.threadId.c_str());
            ...
            if (ImGui::BeginTabItem("Styles"))
            {
                ...
                if (ImGui::BeginTable("StylesTable", 2))
                {
                    ...
                    ImGui::Text("Style:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.style.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("ExStyle:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s", state.exStyle.c_str());

                    ImGui::TableNextRow();
                    ImGui::TableSetColumnIndex(0);
                    ImGui::Text("Rectangle:");
                    ImGui::TableSetColumnIndex(1);
                    ImGui::Text("%s %s", state.position.c_str(), state.size.c_str());
